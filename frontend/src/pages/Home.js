				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						...
						<Link to={isAdmin() ? '/admin' : '/dashboard'} className="card text-center hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600">Our intelligent chatbot understands natural language, responds to FAQs, and handles voice commands and image uploads.</p>
						</Link>
						...
						<Link to={isAdmin() ? '/admin' : '/dashboard'} className="card text-center hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600">Automatically logs, categorizes, prioritizes, and assigns tickets to the appropriate team based on AI analysis.</p>
						</Link>
						...
						<Link to={isAdmin() ? '/admin' : '/dashboard'} className="card text-center hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600">Track your complaint progress in real-time with status updates and notifications at each stage of resolution.</p>
						</Link>
					</div>
				</div>
			</section>
				...
				<div className="container mx-auto px-4">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						...
						<Link to={isAdmin() ? '/admin' : '/dashboard'} className="card hover:shadow-lg transition-shadow duration-300">
							...
							<p className="text-gray-600">Upload images of the issue you're facing. Our YOLOv8 model will analyze the images to detect and categorize the problem.</p>
						</Link>
					</div>
				</div>
			</section>
						...
						<div className="relative">
							...
							<div className="relative mb-12">
								<div className="flex flex-col md:flex-row items-center">
									...
									<div className="z-10 flex items-center justify-center w-12 h-12 rounded-full bg-primary-500 text-white font-bold">3</div>
									<div className="flex-1 md:pl-8 hidden md:block"></div>
								</div>
							</div>
